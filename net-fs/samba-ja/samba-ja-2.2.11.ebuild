...
# $Header: /home/cvsroot/gentoo-x86/net-fs/samba/samba-2.2.8a.ebuild,v 1.5 2003/10/18 00:59:08 kumba Exp $
...
P="samba-2.2.11-ja-1.0"
S=${WORKDIR}/${P}
SRC_URI="oav? mirror://sourceforge/openantivirus/${PN}-vscan-${VSCAN_VER}.tar.bz2
	http://ftp.ring.gr.jp/pub/net/samba-jp/samba-2.2.11-ja/samba-2.2.11-ja-1.0.tar.bz2"
