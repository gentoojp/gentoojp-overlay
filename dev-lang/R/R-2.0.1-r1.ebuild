...
# $Header: /home/cvsroot/gentoo-x86/dev-lang/R/R-2.0.1-r1.ebuild,v 1.2 2004/12/18 13:08:15 okayama Exp $

inherit 64-bit eutils fortran

IUSE="blas lapack X tcltk gnome zlib bzlib pcre jpeg png readline shared static cjk nls doc mozilla pic lfs"
# lfs: Enable support for > 2GB files on Linux (Large File Support)

DESCRIPTION="R is GNU S - A language and environment for statistical computing and graphics."

MAIN_PATCH="${P}.i18n.main.20041116.patch"
GNOME_PATCH="${P}.i18n.gnome.20041116.patch"
REGEX_PATCH="${P}.i18n.regex.20041116.patch"
REGEXQC_PATCH="${P}.i18n.regexQC.20041116.patch"
TCLTK_PATCH="${P}.i18n.tcltk.20041116.patch"
X11_PATCH="${P}.i18n.x11_mb.20041125.patch"
FIG_PATCH="${P}.l10n.pstex.20041116.patch"
...
SRC_URI="http://cran.r-project.org/src/base/R-2/${P}.tar.gz
	nls? ( http://r.nakama.ne.jp/${P}/patchs/${MAIN_PATCH}
		...
		http://r.nakama.ne.jp/${P}/patchs/${REGEXQC_PATCH}
...
src_install () {
	...
	dodoc AUTHORS COPYING* COPYRIGHTS ChangeLog FAQ INSTALL *NEWS \
