...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-x11/xorg-x11-6.8.2-r6.ebuild,v 1.1 2005/10/03 19:50:38 joshuabaergen Exp $
...
do_patch() {
	...
	epatch ${PATCHDIR}
	cd ${S}
	epatch ${FILESDIR}/fcpackage.2_1-Xft-2.0.1-fix-cjk-20041113.diff
}
