...
src_unpack() {
	...
	cp ${FILESDIR}/20*_all_mpg123*.patch ${PATCHDIR}
...
pkg_postinst() {
	...
	ewarn "while it is still in package.mask. Additionally, this version tries"
	ewarn "to switch cjk support into ID3V1 encoding override feature and"
	ewarn "UTF-8 support for ID3V2."
}
