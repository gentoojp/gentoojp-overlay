...
SRC_URI="${ATOKX}.tgz
	http://www3.justsystem.co.jp/download/atok/up/lin/${ATOKX_PATCH}
	!system-iiimf? (
...
pkg_nofetch() {
	einfo "Please mount ATOKX cdrom and copy the files listed below"
	einfo "to ${DISTDIR}"
	einfo ""
	einfo "  - ${ATOKX}.tgz"
	...
	einfo ""
	einfo "Please make sure to copy the tgz files and not the rpms"
}
