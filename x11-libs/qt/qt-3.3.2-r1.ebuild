...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt/qt-3.3.2-r1.ebuild,v 1.12 2004/08/04 09:44:39 tgall Exp $
...
src_unpack() {
	...
	use cjk && epatch ${FILESDIR}/${P}-xim-toUseAtokx-20040804.patch
