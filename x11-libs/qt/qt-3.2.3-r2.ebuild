...
# $Header: /home/cvsroot/gentoo-x86/x11-libs/qt/qt-3.2.3-r2.ebuild,v 1.3 2004/02/03 22:44:03 caleb Exp $
...
IUSE="cjk cups nas postgres opengl mysql odbc gif doc"
...
src_unpack() {
	...
	use cjk && epatch ${FILESDIR}/${P}-xim-toUseAtokx-20030313.patch
