...
DESCRIPTION="Webmail for nuts! (gentoojp)"
...
SRC_URI="mirror://sourceforge/${PN}/${MY_P}.tar.bz2
	...
	nls? ( mirror://sourceforge/${PN}/all_locales-${LOCALES_VER}.tar.bz2 
		http://www.yamaai-tech.com/~masato/Download/${P}-ja-20071215-patch.gz )"
...
src_unpack() {
	...
	use nls &&
		...
		epatch "${DISTDIR}/${P}-ja-20071215-patch.gz" # gentoojp modified
}
