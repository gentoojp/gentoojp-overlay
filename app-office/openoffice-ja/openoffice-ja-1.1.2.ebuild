...
# $Header: /home/cvsroot/gentoo-x86/app-office/openoffice-ja/openoffice-ja-1.1.2.ebuild,v 1.2 2004/08/28 00:15:26 okayama Exp $
...
src_unpack() {
	...
	cd ${WORKDIR}
	unpack OOo_${PV}_source.tar.gz gpc231.tar.Z

	# Install gpc
	cp gpc231/gpc.* ${S}/external/gpc
	...
	# Linux/SPARC fixes
	use sparc && epatch ${FILESDIR}/linux-sparc.patch
	...
	for app in writer calc chart basic math impress draw ; do
		mkdir -p    ${S}/helpcontent/unx/s${app}/japanese
		unzip -o -d ${S}/helpcontent/unx/s${app}/japanese s${app}81.zip
	done
