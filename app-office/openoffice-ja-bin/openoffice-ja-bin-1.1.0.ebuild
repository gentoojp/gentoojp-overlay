...
# $Header: /home/cvsroot/gentoo-x86/app-office/openoffice-bin/openoffice-bin-1.1.0.ebuild,v 1.8 2004/01/24 13:54:07 suka Exp $
...
MY_PV="${PV}"
MY_P="OOo_${MY_PV}_LinuxIntel_install_ja"
S="${WORKDIR}/${MY_P}"

DESCRIPTION="Japanese OpenOffice productivity suite"
SRC_URI="http://www.ring.gr.jp/pub/misc/openoffice/localized/ja/${PV}/${MY_P}.tar.gz"
