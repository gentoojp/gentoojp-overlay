...
# $Header: /home/cvsroot/gentoo-x86/app-office/openoffice-bin/openoffice-bin-1.1.3.ebuild,v 1.0 2004/10/30 00:29:06 lv Exp $
...
INSTDIR="${LOC}/OpenOffice.org1.1.3"
MY_P="OOo_${PV}_LinuxIntel_install_ja"

S="${WORKDIR}/${MY_P}"

DESCRIPTION="OpenOffice productivity suite"

SRC_URI="http://ftp.kddlabs.co.jp/office/openoffice/localized/ja/${PV}/OOo_${PV}_LinuxIntel_install_ja.tar.gz"
