...
# $Header: /home/cvsroot/gentoo-x86/app-office/openoffice-bin/openoffice-bin-1.1.1.ebuild,v 1.8 2004/05/12 07:14:06 lv Exp $
...
INSTDIR="${LOC}/OpenOffice.org1.1.1"
MY_P="OOo_${PV}_LinuxIntel_install_curvirgo"

S="${WORKDIR}/install"

DESCRIPTION="OpenOffice productivity suite"

SRC_URI="http://ring-test.e-trees.jp/waooo/${PV}_ja/OOo_${PV}_LinuxIntel_install_ja_curvirgo.tar.gz"
