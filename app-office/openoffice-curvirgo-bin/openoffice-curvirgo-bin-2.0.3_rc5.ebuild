...
RPM_P=${PV/_rc/-}
SFN="20486"
SRC_URI="mirror://sourceforge.jp/waooo/${SFN}/OOo_${MY_PV}_LinuxIntel_install_ja_curvirgo_rpm_core.tar.bz2
	mirror://sourceforge.jp/waooo/${SFN}/OOo_${MY_PV}_LinuxIntel_install_ja_curvirgo_rpm_other.tar.bz2"
RESTRICT="nomirror"
...
src_unpack() {
	...
	rpm_unpack ${S}/desktop-integration/openoffice.org-freedesktop-menus-${RPM_P}.noarch.rpm
	use kde && rpm_unpack ${S}/desktop-integration/openoffice.org-suse-menus-${RPM_P}.noarch.rpm
