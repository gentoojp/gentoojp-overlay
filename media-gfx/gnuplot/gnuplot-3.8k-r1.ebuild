...
IUSE="doc emacs gd ggi pdflib plotutils png readline svga X xemacs cjk"
MY_P="${P}.3"

DESCRIPTION="Command-line driven interactive plotting program"
HOMEPAGE="http://www.gnuplot.info/ http://www.yama-ga.com/gnuplot/
	http://takeno.iee.niit.ac.jp/~shige/unix/gnuplot/gnuplot.html"
SRC_URI="mirror://sourceforge/gnuplot/${MY_P}.tar.gz
	X? http://takeno.iee.niit.ac.jp/~shige/unix/gnuplot/data/tgif-lw-mc3.diff
	cjk? http://f21.aaacafe.ne.jp/~oden/software/${MY_P}+0.10.patch.tar.gz"
LICENSE="gnuplot"
...
src_unpack() {
	...
	if use cjk
	then
		unpack ${MY_P}+0.10.patch.tar.gz
		epatch ${MY_P}+0.10.patch
		touch aclocal.m4 configure
	fi
	if use X
	then
		cp ${DISTDIR}/tgif-lw-mc3.diff .
		epatch ${FILESDIR}/tgif-lw-mc3.diff.patch
		epatch tgif-lw-mc3.diff
	fi
