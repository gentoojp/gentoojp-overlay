...
SRC_URI="mirror://sourceforge/xu4/${MY_P}.tar.gz
...
src_unpack() {
	...
	sed -i \
		-e "s:/usr/local/lib/u4:${GAMES_LIBDIR}/u4:" src/u4file.cpp \
...
pkg_postinst() {
	einfo "Config file is moved from $HOME/.xu4rc to $HOME/.u4/xu4rc ."
	einfo "If you upgraded from xu4-0.9, you should move this file"
	einfo "by yourself."
}
